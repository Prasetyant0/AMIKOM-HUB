...
const COURSE_MODULES: CourseModule[] = [
    { week: '01', title: 'INTRODUKSI BRUTALISME', duration: '25 MENIT', status: 'SELESAI' },
    { week: '02', title: 'SISTEM DESAIN 101', duration: '35 MENIT', status: 'SEDANG BERJALAN' },
    { week: '03', title: 'TIPOGRAFI - ATURAN GRID', duration: '45 MENIT', status: 'TERKUNCI' },
    { week: '04', title: 'PSIKOLOGI SHADOW TAJAM', duration: '40 MENIT', status: 'TERKUNCI' },
    { week: '05', title: 'REVIEW PROYEK AKHIR', duration: '60 MENIT', status: 'TERKUNCI' }
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 flex flex-col gap-6">
                    ...
                    <span className="inline-flex items-center gap-2 w-fit px-3 py-1 bg-brutal-yellow border-2 border-black text-xs font-black uppercase">
                        SEDANG MENONTON: MODUL 02 - SISTEM DESAIN 101
                    </span>
                            ...
                            {COURSE_MODULES.map((module, index) => (
                                ...
                                >
                                    <div className="flex justify-between items-center">
                                        <span className="text-2xl font-black">{module.week}</span>
